      ...
      <div className="collapse navbar-collapse" id="navbarText">
        <ul className="navbar-nav animate side-nav">
          <li className="nav-item">
            <a className="nav-link"  title="Dashboard"><i className="fas fa-cube"></i> Dashboard <i className="fas fa-cube shortmenu animate"></i></a>
          </li>
          <li className="nav-item">
            <a className="nav-link"  title="Cart"><i className="fas fa-cart-plus"></i> Cart <i className="fas fa-cart-plus shortmenu animate"></i></a>
          </li>
        </ul>
        <ul className="navbar-nav ml-md-auto d-md-flex">
          <li className="nav-item">
            <a className="nav-link"><i className="fas fa-user"></i> Profile</a>
          </li>
          <li className="nav-item">
            <a className="nav-link"><i className="fas fa-key"></i> Logout</a>
          </li>
        </ul>
      </div>
    </nav>
